...
<img src="docs/dashboard.png" alt="A Loupe trace waterfall: nine rows, each a real LLM call or tool call from a live run, with proportional duration bars showing the agent searching docs, fetching detail pages, and reasoning between steps." width="720" />

**Contents:** [Why this is real](#why-this-is-real-not-a-demo) · [Architecture](#architecture) · [Local development](#local-development) · [In-app commands](#local-development) · [Out of scope](#deliberately-out-of-scope-for-v1) · [License](#license)
